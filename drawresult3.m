...
figure;
plot(xub, ub, 'k--', t1, wavesum(x0, x1, x2, x3, h, r, t1, xnum, tnum, Nmax), 'k-', t1, wavesum(x0(1), x1(1), x2(1), x3(1), h(1), r(1), t1, 1, tnum, Nmax(1)), 'k-.', t1, wavesum(x0(1), x1(2), x2(2), x3(2), h(2), r(2), t1, 1, tnum, Nmax(2)), 'k:');
% hold on
